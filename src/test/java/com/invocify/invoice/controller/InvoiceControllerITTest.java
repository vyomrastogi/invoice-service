...
class InvoiceControllerITTest {
  ...
  public void createInvoicewithLineItems() throws Exception {
    ...
    LineItem lineItem1 =
        LineItem.builder()
            ...
            .quantity(4)
            .rate(new BigDecimal(10.3))
            .rateType("rate")
            .build();
    requestInvoice.setLineItems(
  ...
  public void createInvoiceWithoutCompanyAndAuthor() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(
            jsonPath("$.errors[1]").value("Invoice should be associated with an existing company"));
  }
  ...
  public void createInvoiceWithInvalidCompany() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(
            jsonPath("$.errors[0]")
                .value(String.format("Given company not found: %s", id.toString())));
  }
  ...
  public void getListOfInvoices() throws Exception {
    createInvoice(1);
    mockMvc
        .perform(get("/api/v1/invocify/invoices"))
  ...
  public void getListOfInvoicesWithDefaultPaginationAndSort() throws Exception {
    ...
    mockMvc
        ...
        // validate that first element is last added element and last element is oldest added
        // element
        .andExpect(
            jsonPath("$.data.invoices[0].lineItems[0].description").value("Service line item 14"))
        .andExpect(
            jsonPath("$.data.invoices[9].lineItems[0].description").value("Service line item 5"));
  }
  ...
  public void getListOfInvoicesWithCustomPagination() throws Exception {
    ...
    mockMvc
        .perform(get("/api/v1/invocify/invoices").param("page", "1"))
        .andExpect(status().isOk())
        ...
        // element
        .andExpect(
            jsonPath("$.data.invoices[0].lineItems[0].description").value("Service line item 4"))
        .andExpect(
            jsonPath("$.data.invoices[4].lineItems[0].description").value("Service line item 0"));
  }
  ...
  public void getListOfInvoicesFilterWithDuration() throws Exception {
    ...
    mockMvc
        ...
        // element
        .andExpect(
            jsonPath("$.data.invoices[0].lineItems[0].description").value("Service line item 2"));
  }
  ...
  private void createInvoice(int count) throws Exception {
    ...
    LineItem lineItem =
        LineItem.builder()
            .description("Service line item " + count)
            .quantity(1)
            .rate(new BigDecimal(15.3))
            .rateType("flat")
            .build();
  ...
  public void getListOfAllInvoicesWithPaginationAndSorting() throws Exception {
    ...
    mockMvc
        ...
        // element
        .andExpect(
            jsonPath("$.data.invoices[0].lineItems[0].description").value("Service line item 19"))
        .andExpect(
            jsonPath("$.data.invoices[9].lineItems[0].description").value("Service line item 10"));
    ...
    mockMvc
        ...
        // element
        .andExpect(
            jsonPath("$.data.invoices[0].lineItems[0].description").value("Service line item 9"))
        .andExpect(
            jsonPath("$.data.invoices[9].lineItems[0].description").value("Service line item 0"));
  }
}
