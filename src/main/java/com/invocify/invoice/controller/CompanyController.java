...
public class CompanyController {
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Company is created successfully",
            content = {
              @Content(
        ...
        @ApiResponse(
            responseCode = "400",
            description = "Invalid CompanyRequest supplied",
  ...
  @Operation(
      description = "Get all companies simplified view or detail view",
  ...
  public BaseResponse getAllCompanies(
      @Parameter(description = "All the details of the Company")
          @RequestParam(required = false, defaultValue = "false")
          boolean includeDetail,
      @Parameter(description = "All the companies including inactive")
          @RequestParam(required = false, defaultValue = "false")
  ...
  @Operation(
      description = "Ability to update company status to inactive. CompanyId is required*",
      summary = "Update the status to inactive for given companyId ")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Updated the status of Company to inactive",
            content = {@Content(mediaType = "application/json")}),
        @ApiResponse(
            responseCode = "400",
            description = "Invalid companyId supplied",
            content = @Content(mediaType = "application/json"))
      })
  ...
  @Operation(
      description =
          "Ability to update company details and also update the active status. All fields are required*",
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "400",
            description = "Invalid companyId supplied or Invalid company request",
            content = @Content(mediaType = "application/json"))
      })
  @PutMapping("/{companyId}")
  public BaseResponse modifyCompany(
      @PathVariable UUID companyId, @Valid @RequestBody CompanyRequest company)
