...
public class InvocifyControllerAdvice {
  ...
  public BaseResponse handleNotFound(
  ...
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  public BaseResponse handleInvalidCompanyException(
      InvalidCompanyException invalidCompanyException) {
    return generateResponse(invalidCompanyException.getMessage());
  }

  @ExceptionHandler(InvoiceNotFoundException.class)
  @ResponseStatus(HttpStatus.NOT_FOUND)
  public BaseResponse handleInvoiceNotFoundException(
  ...
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  public BaseResponse handleInvoiceAlreadyPaidException(
      InvoiceAlreadyPaidException invoiceAlreadyPaidException) {
