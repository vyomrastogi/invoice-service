...
public class CompanyService extends InvocifyServiceHelper {
  ...
  public List<? extends CompanyBaseResponse> getAllCompanies(
      boolean includeDetail, boolean includeInactive) {
  ...
  public Company modifyCompany(UUID companyId, CompanyRequest companyRequest)
